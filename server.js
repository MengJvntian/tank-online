...
function createEnemy(room,kind){const spots=[{x:0,y:0},{x:5*TILE,y:0},{x:10*TILE,y:0},{x:15*TILE,y:0},{x:20*TILE-26,y:0}],sp=spots[Math.floor(Math.random()*spots.length)];if(blocked(room,sp.x,sp.y,26,false))return false;const stat={normal:{hp:1,speed:1.2,color:'#ef4444',score:100},fast:{hp:1,speed:2.0,color:'#f97316',score:150},heavy:{hp:3,speed:.9,color:'#a855f7',score:250},sniper:{hp:1,speed:1.0,color:'#06b6d4',score:220},suicide:{hp:1,speed:2.45,color:'#f59e0b',score:180},shield:{hp:2,speed:1.05,color:'#22d3ee',score:260},elite:{hp:4,speed:1.35,color:'#84cc16',score:360},bossFrost:{hp:24,speed:.68,color:'#60a5fa',score:1700},bossThunder:{hp:28,speed:.9,color:'#facc15',score:1900},bossShadow:{hp:30,speed:1.02,color:'#7c3aed',score:2100},bossDoom:{hp:32,speed:.74,color:'#be123c',score:2600},boss:{hp:16,speed:.7,color:'#be123c',score:1500}}[kind];room.enemies.push({id:'E'+Math.random().toString(36).slice(2,8),x:sp.x,y:sp.y,size:26,dir:'down',kind,hp:stat.hp,maxHp:stat.hp,speed:stat.speed,color:stat.color,score:stat.score,cooldown:60,moveTimer:20});return true;}
